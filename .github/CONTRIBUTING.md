# Contributing to Pixi Chocolatey Package

Thank you for considering contributing to the Pixi Chocolatey Package! Your help is greatly appreciated.
...
2. **Clone your fork**: Clone your forked repository to your local machine using the following command:
   ...
   ```bash
   git clone https://github.com/your-username/pixi-chocolatey-package.git
   ```
...
If you encounter any issues or have suggestions for improvements, please open an issue in the [GitHub Issues](https://github.com/MKAbuMattar/pixi-chocolatey-package/issues) section.
